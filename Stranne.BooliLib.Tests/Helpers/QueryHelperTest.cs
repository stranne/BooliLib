...
namespace Stranne.BooliLib.Tests.Helpers
{
    ...
    public class QueryHelperTest
    {
        ...
        public static readonly TheoryData GetQueryListedMemberData = new TheoryData<string, object, string, string>
        {
            ...
            {nameof(ListedSearchOption.ObjectTypes), new[] {ObjectType.Lägenhet, ObjectType.Villa}, "objectTypes", "lägenhet,villa"},
        ...
        public static readonly TheoryData GetQuerySoldMemberData = new TheoryData<string, object, string, string>
        {
            ...
            {nameof(SoldSearchOption.ObjectTypes), new[] {ObjectType.Lägenhet, ObjectType.Villa}, "objectTypes", "lägenhet,villa"},
        ...
        public static readonly TheoryData GetQueryAreaMemberData = new TheoryData<string, object, string, string>
        {
